...
public class FloorGeneratorBAPC2022 extends FloorGenerator {
	...
	private static final List<Integer> skippedTeams = new ArrayList<>();
	private static final HashMap<Integer, Integer> teamsPerRoom = new HashMap<>();
...
//		teamsPerRoom.put(9, 5);
//		teamsPerRoom.put(10, 5);
		...
		try {
			...
			FloorMap.Path path2 = floor.getPath(floor.getTeam(29), p);
